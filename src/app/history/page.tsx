...
import { ArrowDownLeft, ArrowUpRight, Repeat, DollarSign, Filter, Search, ExternalLink } from 'lucide-react';
...
const TRANSACTIONS: Transaction[] = [
  { id: '1', type: 'borrow', asset: 'VUSD', amount: 5000, usdValue: 5000, timestamp: '2025-10-07T14:30:00', status: 'success', txHash: '5KJp...9Rz2' },
  { id: '2', type: 'deposit', asset: 'SOL', amount: 50, usdValue: 9787.50, timestamp: '2025-10-07T12:15:00', status: 'success', txHash: '3Hk8...7Mn4' },
  { id: '3', type: 'swap', asset: 'USDC', amount: 1000, usdValue: 1000, timestamp: '2025-10-06T18:45:00', status: 'success', txHash: '8Ym3...2Qr1', from: 'USDT', to: 'USDC' },
  { id: '4', type: 'repay', asset: 'VUSD', amount: 2500, usdValue: 2500, timestamp: '2025-10-06T09:20:00', status: 'success', txHash: '2Fp9...4Ls8' },
  { id: '5', type: 'deposit', asset: 'jitoSOL', amount: 25, usdValue: 5016.25, timestamp: '2025-10-05T16:30:00', status: 'success', txHash: '9Bv7...3Kt5' },
  { id: '6', type: 'withdraw', asset: 'USDC', amount: 3000, usdValue: 3000, timestamp: '2025-10-05T11:10:00', status: 'success', txHash: '4Dx2...8Wn9' },
  { id: '7', type: 'borrow', asset: 'VUSD', amount: 3500, usdValue: 3500, timestamp: '2025-10-04T15:50:00', status: 'success', txHash: '6Hn1...5Pr6' },
  { id: '8', type: 'deposit', asset: 'mSOL', amount: 15, usdValue: 2958, timestamp: '2025-10-04T08:25:00', status: 'success', txHash: '1Qw5...7Zx3' },
];

const TRANSACTION_CONFIG: Record<TransactionType, { icon: React.ComponentType<{ className?: string }>; color: string; label: string }> = {
        ...
        <div className="max-w-6xl mx-auto space-y-6">
          ...
          <div className="grid grid-cols-3 gap-4">
            <Card className="p-4 backdrop-blur-xl bg-surface/70 border-border/50">
              <div className="text-xs text-text-tertiary uppercase tracking-wider font-bold mb-2">Total Volume</div>
            ...
            <Card className="p-4 backdrop-blur-xl bg-surface/70 border-border/50">
              <div className="text-xs text-text-tertiary uppercase tracking-wider font-bold mb-2">Total Transactions</div>
            ...
            <Card className="p-4 backdrop-blur-xl bg-surface/70 border-border/50">
              <div className="text-xs text-text-tertiary uppercase tracking-wider font-bold mb-2">Most Active</div>
                ...
                return (
                  ...
                  >
                    <Card className="p-4 backdrop-blur-xl bg-surface/70 border-border/50 hover:bg-elevated/50 transition-all">
                      <div className="flex items-center gap-4">
                        {/* Icon */}
                        <div className={`w-10 h-10 rounded-xl bg-base border border-border flex items-center justify-center shrink-0 ${config.color}`}>
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-2 mb-1">
                            <div className="text-sm font-bold text-text-primary">{config.label}</div>
                            {tx.from && tx.to && (
                          ...
                          <div className="flex items-center gap-2 text-xs text-text-tertiary">
                            <span>{formatNumber(tx.amount, 4)} {tx.asset}</span>
                            <span>•</span>
